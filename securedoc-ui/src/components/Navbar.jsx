        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center">
            <Link to="/" className="flex items-center space-x-3 group">
              <div className="flex items-center justify-center w-10 h-10 bg-gradient-to-br from-primary-500 to-primary-600 rounded-xl shadow-md group-hover:shadow-lg transition-all duration-300">
              ...
              <div className="hidden sm:block">
                ...
                <p className="text-xs text-gray-500 -mt-1">Document Protection Platform</p>
              </div>
            </Link>
          </div>
